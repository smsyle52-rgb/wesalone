...
آخر تحديث: 3 يوليو 2026 (Claude — أعِد ترتيب «المزيد» على الجوال بأقسام مجمّعة مطابقة لتصنيف الديسكتوب: أُضيفت 5 أقسام كانت غائبة تماماً عن الجوال (الفرص/الديون/التقارير/سجل النشاط/الفوترة)، أُزيل رابط ميت («الحملات»)، وأُصلحت صلاحية خاطئة كانت تُخفي «الفريق والصلاحيات» حتى عن المالك؛ + اختبار وظيفي شامل لكل أزرار المحادثة كشف عطلاً كبيراً: بث SSE اللحظي + الردود السريعة + العروض المحفوظة + قواعد SLA معطّلة بالكامل منذ البداية (مسار غير مسجَّل) — أُصلح وتحقّق حيّاً؛ + محادثة الجوال ملء-شاشة + إعادة تصميم الوارد ديسكتوب؛ جاهز للدفع)
