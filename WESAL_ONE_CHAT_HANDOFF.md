...
**بوابة الإغلاق:** ✅ **جاهزة للإغلاق** — M-3 (ربط المخزون ببنود الطلب) مُنشَر + الدفعة 3 (`get_order_status`) مبنية. يتبقّى **النشر + اختبار حيّ**: في محادثة لعميل له طلب، اسأل «وين طلبي؟» → يجب أن يردّ الوكيل بحالة الطلب والتوصيل ورقم المندوب.
