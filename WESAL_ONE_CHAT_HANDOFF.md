...
| **النطاق 8** | الوسائط (PD-3) | ⏸️ مؤجّل بقرار المالك | `86fa6cb` |
| **النطاق 9** | الأتمتة والمتابعة والبث | ✅ مُغلق (الأتمتة مؤجّلة بقرار) | — |
| **النطاق 10** | جهات الاتصال | 🔍 قيد التحقق والتكميل | `cc9baf6` |
...
| PD-3 | الوسائط في الوارد (عرض + إرسال) | ⏸️ مؤجّل بقرار المالك | — |
