...
function BrandMark({ size = 44, mono = false }) {
  ...
  return (
    ...
    >
      <defs>
        <radialGradient cx="42%" cy="32%" id={sphere} r="78%">
        ...
        <radialGradient cx="50%" cy="50%" id={rim} r="50%">
        ...
        <linearGradient id={topg} x1="0" x2="0" y1="0" y2="1">
          <stop offset="0%" stopColor="#BAE6FD" stopOpacity="0.35" />
          <stop offset="100%" stopColor="#BAE6FD" stopOpacity="0" />
        </linearGradient>
        <radialGradient cx="50%" cy="50%" id={botg} r="50%">
          <stop offset="0%" stopColor="#22D3EE" stopOpacity="0.9" />
          <stop offset="100%" stopColor="#22D3EE" stopOpacity="0" />
        </radialGradient>
        <linearGradient id={wf} x1="0.3" x2="0.6" y1="0" y2="1">
        ...
        <linearGradient id={wf2} x1="0.3" x2="0.6" y1="0" y2="1">
      ...
      <circle cx="60" cy="60" fill={`url(#${sphere})`} r="57" />
      <g clipPath={`url(#${clip})`}>
        <path
          d="M-10 78 Q40 58 130 92"
          fill="none"
          opacity="0.7"
          stroke={`url(#${band})`}
          strokeWidth="3.5"
        ...
        />
        <path
          d="M-10 40 Q60 30 130 52"
          fill="none"
          opacity="0.4"
          stroke={`url(#${band})`}
          strokeWidth="2.5"
        />
        <ellipse cx="58" cy="30" fill={`url(#${topg})`} rx="44" ry="24" />
        <ellipse
          cx="60"
          cy="80"
          fill={`url(#${botg})`}
      ...
      <circle cx="60" cy="60" fill={`url(#${rim})`} r="57" />

      <g strokeLinecap="round" strokeLinejoin="round">
        <path
          d="M31 39 L48 35 L47 83 Z"
          fill={`url(#${wf})`}
          stroke={`url(#${wf})`}
          strokeWidth="9"
        />
        <path
          d="M57 35 L74 39 L64 83 Z"
          fill={`url(#${wf2})`}
          stroke={`url(#${wf2})`}
          strokeWidth="9"
        />
        <path
          d="M80 38 L94 42 L88 65 Z"
          fill={`url(#${wf})`}
          stroke={`url(#${wf})`}
          strokeWidth="8"
        />
    ...
    return (
      <img
        ...
        style={{
          ...
          display: "block",
          boxShadow: "0 6px 18px rgba(8,17,39,0.35)",
        }}
        width={size}
      />
    )
...
function InstagramIcon({ size = 28 }) {
  ...
  return (
    <svg aria-hidden="true" height={size} viewBox="0 0 32 32" width={size}>
      <defs>
        <linearGradient id={`ig-${id}`} x1="0" x2="1" y1="1" y2="0">
      ...
      <rect fill={`url(#ig-${id})`} height="32" rx="9" width="32" x="0" y="0" />
      <rect
        fill="none"
        height="16"
        rx="5"
      ...
      <circle
        ...
        strokeWidth="2"
      />
      <circle cx="21.2" cy="10.8" fill="#fff" r="1.1" />
    </svg>
  )
}
...
function MessengerIcon({ size = 28 }) {
  ...
  return (
    <svg aria-hidden="true" height={size} viewBox="0 0 32 32" width={size}>
      ...
      <circle cx="16" cy="16" fill={`url(#mg-${id})`} r="16" />
      <path
...
function TelegramIcon({ size = 28 }) {
  ...
  return (
    <svg aria-hidden="true" height={size} viewBox="0 0 32 32" width={size}>
      ...
      <circle cx="16" cy="16" fill={`url(#tg-${id})`} r="16" />
      <path
...
function ChannelIcons({ animated = true, size = 56, withLabels = false }) {
  ...
  return (
    <div
      className="flex items-center justify-center gap-5 sm:gap-7 flex-wrap"
      dir="ltr"
    >
      {items.map((it, i) => (
        <div className="flex flex-col items-center gap-2" key={it.name}>
          <div
...
function ChBadge({ kind, size = 14 }) {
  ...
  return (
    <span
      className="grid place-items-center rounded-full text-white font-bold ring-2"
      style={{
        width: size,
        height: size,
        background: c.bg,
  ...
  return (
    <div className="mini-inbox-card relative" dir="rtl">
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(50% 50% at 50% 30%, color-mix(in srgb, var(--primary) 25%, transparent), transparent 70%)",
          filter: "blur(40px)",
        }}
      />
      ...
      {/* Tabs قنوات */}
      <div
        className="mini-inbox-tabs flex flex-wrap items-center gap-1 px-3 py-2.5 border-b overflow-visible sm:flex-nowrap sm:overflow-x-auto"
        style={{ borderColor: "var(--line)" }}
      >
        {tabs.map((t) => {
      ...
      <div className="divide-y" style={{ "--tw-divide-opacity": 1 }}>
        {rows.map((r, i) => {
          ...
          return (
            <div
              className="inbox-row flex items-start gap-2.5 px-4 py-3 cursor-pointer"
              key={i}
              style={{
            ...
            >
              <div className="relative shrink-0">
                <div
                  className="w-9 h-9 rounded-full grid place-items-center text-white text-[12px] font-extrabold"
                  style={{ background: r.c }}
                >
                  {r.n.charAt(0)}
                </div>
                <div className="absolute -bottom-0.5 -start-0.5">
                  <ChBadge kind={r.ch} size={14} />
                </div>
              </div>
              <div className="flex-1 min-w-0">
                ...
                <div className="mt-1.5 flex items-center gap-1.5">
                  <span
                    ...
                    style={{
                      background: `color-mix(in srgb, ${r.sCol} 14%, transparent)`,
                      color: r.sCol,
                    }}
                  >
                    <span
                      className="w-1 h-1 rounded-full"
                      style={{ background: r.sCol }}
                    ></span>
                    {r.status}
                  </span>
                </div>
              ...
              {r.u && (
                <span
                  className="text-[9.5px] font-extrabold text-white rounded-full px-1.5 py-0.5 shrink-0 mt-1"
  ...
  return (
    <div className="operations-board relative" dir="rtl">
      ...
      >
        ...
        <button
          className="inline-flex items-center gap-1.5 text-[10.5px] font-extrabold px-3 py-1.5 rounded-lg text-white"
          style={{
            background:
          ...
          >
            <div className="flex items-center justify-between px-1">
              <div className="flex items-center gap-1.5">
                <span
                  className="w-1.5 h-1.5 rounded-full"
                  style={{ background: col.c, boxShadow: `0 0 8px ${col.c}` }}
                ></span>
                <span className="text-[10.5px] font-extrabold">{col.l}</span>
              </div>
              <span className="text-[9.5px] text-mute font-bold">
                {tasks[col.id].length}
              </span>
            </div>
            ...
            {tasks[col.id].map((t, i) => (
              <div
                className="task-card p-2.5 rounded-lg cursor-pointer"
                key={i}
                style={{
              ...
              >
                <div className="flex items-center justify-between mb-1.5">
                  ...
                  <span
                    className="inline-flex items-center gap-1 text-[8.5px] font-extrabold px-1.5 py-0.5 rounded-md"
                    style={{
                      background: `color-mix(in srgb, ${t.priCol} 16%, transparent)`,
                      color: t.priCol,
                    }}
                  >
                    <span
                      className="w-1 h-1 rounded-full"
                      style={{ background: t.priCol }}
                    ></span>
                    {t.priority}
                  </span>
                </div>

                <p className="text-[10.5px] font-bold leading-tight line-clamp-2 mb-2">
                  {t.title}
                </p>
                ...
                >
                  <div className="flex items-center gap-1 min-w-0">
                    <div
                      className="w-4 h-4 rounded-full grid place-items-center text-white text-[7px] font-extrabold shrink-0"
                      style={{
                        background:
                          "linear-gradient(135deg, var(--primary), var(--secondary))",
                      }}
      ...
      {/* بطاقة اقتراح توزيع */}
      <div
        className="m-3 mt-0 p-3 rounded-xl"
        style={{
          background: "color-mix(in srgb, var(--secondary) 10%, transparent)",
          border:
            "1px solid color-mix(in srgb, var(--secondary) 28%, transparent)",
...
function MiniChartLine({ pts, color, height = 56, animated = true }) {
  ...
  return (
    ...
    >
      <defs>
        <linearGradient id={`mc-${id}`} x1="0" x2="0" y1="0" y2="1">
          <stop offset="0%" stopColor={color} stopOpacity="0.35" />
          <stop offset="100%" stopColor={color} stopOpacity="0" />
        </linearGradient>
      </defs>
      <path
        d={`${d} L 195 ${height} L 5 ${height} Z`}
        fill={`url(#mc-${id})`}
      />
      <path
        d={d}
        ...
        style={
          animated && len
            ? {
                ...
                animation: `drawLine 1.6s ease-out .2s forwards`,
              }
            : {}
        }
      />
  ...
  return (
    <div className="analytics-dashboard relative" dir="rtl">
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(50% 50% at 50% 30%, color-mix(in srgb, var(--secondary) 22%, transparent), transparent 70%)",
          filter: "blur(40px)",
        }}
      />
      ...
      >
        ...
        <div className="flex items-center gap-1.5">
          ...
          <button
            className="inline-flex items-center gap-1 text-[10px] font-extrabold px-2.5 py-1.5 rounded-lg text-white"
            style={{
              background:
                "linear-gradient(135deg, var(--primary), var(--secondary))",
            }}
      ...
      <div className="kpi-grid p-3 gap-2">
        {kpis.map((k, i) => (
          <div
            className="kpi-card p-3 rounded-xl"
            key={k.l}
            style={{
              background: "rgba(255,255,255,0.04)",
              border: "1px solid var(--line)",
          ...
          >
            <div className="flex items-center justify-between mb-2">
              ...
              <span
                ...
                style={{
                  background: `color-mix(in srgb, ${k.c} 16%, transparent)`,
                  color: k.c,
                }}
              >
                {k.icon === "clock" && (
                ...
                {k.icon === "smile" && (
                  ...
                  >
                    ...
                    <circle cx="9" cy="10" fill="currentColor" r=".8" />
                    <circle cx="15" cy="10" fill="currentColor" r=".8" />
                  </svg>
                )}
                {k.icon === "chart" && (
                  <svg
            ...
            <div
              className="text-[10px] font-extrabold mt-1 flex items-center gap-1"
              style={{
                color:
                  k.dir === "up" || k.dir === "down-good"
                    ? "var(--secondary)"
                    : "#EF4444",
              }}
            >
              <svg
                ...
                stroke="currentColor"
                strokeWidth="3"
                style={{ transform: k.dir === "up" ? "" : "rotate(180deg)" }}
                viewBox="0 0 24 24"
                width="10"
              >
      ...
      <div className="px-3 pb-3 grid lg:grid-cols-[1.4fr,1fr] gap-2">
        ...
        >
          ...
          <MiniChartLine
            ...
            height={84}
            pts={[
              6, 12, 28, 22, 50, 18, 72, 32, 94, 28, 116, 42, 138, 36, 160, 50,
              182, 44,
            ]}
          />
...
function _FlowNode({
  ...
  return (
    <div
      className="automation-node relative p-3 rounded-xl flex flex-col gap-1.5 w-[180px] shrink-0"
      style={{
        background: "rgba(255,255,255,0.04)",
        border: "1px solid var(--line)",
    ...
    >
      ...
      {/* النص */}
      <p className="text-[10px] text-soft leading-relaxed line-clamp-2">
        {text}
      </p>
      {/* الشارة */}
      <div
        className="mt-1 inline-flex items-center self-start gap-1 text-[9px] font-extrabold px-1.5 py-0.5 rounded-md"
        style={{
  ...
  const steps = [
    {
      ...
      icon: (
        <svg
          ...
          width="14"
        >
          <path d="M21 12a8 8 0 01-11.6 7.2L4 21l1.8-5.4A8 8 0 1121 12z" />
        </svg>
      ),
    },
    {
  ...
  return (
    <div className="automation-flow-card relative" dir="rtl">
      ...
      >
        ...
        <div
          className="text-[10px] font-bold px-2.5 py-1.5 rounded-md text-soft"
          style={{
            background: "rgba(255,255,255,0.04)",
            border: "1px solid var(--line)",
          }}
...
function _PCh({ kind, size = 14 }) {
  ...
  return (
    <span
      className="grid place-items-center rounded-full text-white font-extrabold"
      style={{
        width: size,
        height: size,
        background: c.bg,
  ...
  const map = {
    ...
    gear: (
      <g {...s}>
        ...
        <path d="M19 12a7 7 0 00-.2-1.7l2-1.5-2-3.4-2.3 1a7 7 0 00-2.9-1.7L13 2h-2l-.6 2.7a7 7 0 00-2.9 1.7l-2.3-1-2 3.4 2 1.5a7 7 0 000 3.4l-2 1.5 2 3.4 2.3-1a7 7 0 002.9 1.7L11 22h2l.6-2.7a7 7 0 002.9-1.7l2.3 1 2-3.4-2-1.5c.1-.5.2-1.1.2-1.7z" />
      </g>
    ),
    search: (
      <g {...s}>
...
function PlatformDashboard() {
  ...
  return (
    <div
      ...
      style={{
        background:
          "linear-gradient(180deg, rgba(255,255,255,0.04), rgba(255,255,255,0.01)) , var(--card-solid)",
        border: "1px solid var(--line-strong)",
        boxShadow:
          "0 60px 120px -30px rgba(2,6,23,0.85), inset 0 1px 0 rgba(255,255,255,0.08)",
      }}
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(40% 60% at 20% 30%, rgba(37,99,235,0.32), transparent 70%), radial-gradient(40% 60% at 80% 70%, rgba(34,211,238,0.22), transparent 70%)",
          filter: "blur(48px)",
        }}
      />
      ...
      {/* ====== App window chrome ====== */}
      <div
        className="window-chrome flex items-center gap-2 px-4 py-2.5 border-b"
        style={{ borderColor: "var(--line)" }}
      >
      ...
      <div
        className="px-4 py-2.5 border-b flex items-center gap-4 overflow-x-auto"
      ...
      >
        {[
          ...
          <div className="flex items-center gap-2 shrink-0" key={k.l}>
            <span
              className="w-7 h-7 rounded-lg grid place-items-center"
              style={{
                background: `color-mix(in srgb, ${k.c} 16%, transparent)`,
      ...
      <div className="dash-body grid" style={{ minHeight: 460 }}>
        {/* Zone 1: Sidebar */}
        <aside
          className="dash-sidebar p-2.5 border-s flex flex-col"
          style={{
        ...
        >
          ...
          >
            <div
              className="w-7 h-7 rounded-md grid place-items-center text-white text-[10px] font-extrabold"
              style={{
                background:
                  "linear-gradient(135deg, var(--primary), var(--secondary))",
              }}
          ...
          <nav className="space-y-1">
            {[
              ...
              >
                ...
                {n.badge && (
                  <span
                    className="ms-auto text-[8px] font-extrabold px-1.5 py-0.5 rounded-full"
                    style={{
                      background: n.active
                        ? "rgba(255,255,255,0.25)"
                        : "var(--secondary)",
                      color: n.active ? "#fff" : "#fff",
                    }}
                  >
                    {n.badge}
                  </span>
        ...
        <section
          className="dash-list border-s flex flex-col"
          style={{ background: "rgba(0,0,0,0.10)", borderColor: "var(--line)" }}
        >
            ...
            {conversations.map((c) => {
              ...
              return (
                ...
                >
                  <div className="relative shrink-0">
                    <div
                      className="w-8 h-8 rounded-full grid place-items-center text-white text-[11px] font-extrabold"
                      style={{ background: c.color }}
                    >
                      {c.name.charAt(0)}
                    </div>
                    <span className="absolute -bottom-0.5 -start-0.5">
                      <_PCh kind={c.ch} size={13} />
                    </span>
                  </div>
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between gap-2">
                      ...
                      <span className="text-[8.5px] text-mute shrink-0">
                        {c.time}
                      </span>
                    </div>
                    <p className="text-[10px] text-soft truncate mt-0.5">
                      {c.msg}
                    </p>
                  </div>
                  {c.unread > 0 && (
                    <span
                      className="text-[8.5px] font-extrabold text-white rounded-full px-1.5 py-0.5"
                      style={{ background: "var(--secondary)" }}
                    >
                      {c.unread}
                    </span>
        ...
        <section
          className="dash-thread flex-1 min-w-0 flex flex-col"
        ...
        >
          ...
          >
            ...
            <div className="ms-auto flex items-center gap-1.5">
              <button className="w-7 h-7 grid place-items-center rounded-lg text-mute hover:bg-white/5">
                <_SideIcon name="bell" size={13} />
              </button>
              <button className="w-7 h-7 grid place-items-center rounded-lg text-mute hover:bg-white/5">
                <_SideIcon name="user" size={13} />
              </button>
            </div>
          </div>
          ...
          <div className="flex-1 p-4 space-y-2.5 overflow-hidden">
            <div
              className="max-w-[75%] me-auto rounded-2xl rounded-bs-md px-3 py-2 text-[11.5px] leading-relaxed"
              style={{
          ...
          >
            <div
              className="flex-1 text-[10.5px] text-mute rounded-lg px-3 py-2.5"
              style={{
                background: "rgba(255,255,255,0.04)",
                border: "1px solid var(--line)",
              }}
        ...
        {/* Zone 4: Side Panel */}
        <aside
          className="dash-panel border-s p-4 flex flex-col gap-4"
          style={{ background: "rgba(0,0,0,0.20)", borderColor: "var(--line)" }}
        >
          {/* عميل */}
          <div>
            <div className="flex items-center gap-2.5 mb-3">
              <div
                className="w-11 h-11 rounded-full grid place-items-center text-white text-base font-extrabold"
                style={{ background: active.color }}
              >
                {active.name.charAt(0)}
              </div>
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-1.5">
              {[
                ...
                <span
                  className="inline-flex items-center gap-1 text-[10px] font-extrabold px-2 py-1 rounded-md"
                  key={t.l}
                  style={{
                    background: `color-mix(in srgb, ${t.c} 16%, transparent)`,
                    color: t.c,
                  }}
                >
          ...
          <div className="mt-auto">
            ...
            <div className="space-y-1.5">
              <button
                className="w-full flex items-center justify-center gap-2 h-9 rounded-lg text-[11px] font-extrabold text-white"
                style={{ background: "var(--primary)" }}
              >
    ...
    >
      <div className="container-page h-16 flex items-center justify-between gap-4">
        ...
        <nav className="hidden lg:flex items-center gap-6">
          {links.map((l) => (
            <a
              className="text-[13.5px] font-semibold text-soft hover:text-[color:var(--fg)] transition"
              href={l.h}
              key={l.l}
            >
              {l.l}
      ...
      {open && (
        <div
          className="lg:hidden border-t border-line"
          style={{ background: "var(--bg)" }}
        >
          <div className="container-page py-3 flex flex-col gap-1">
            {links.map((l) => (
              <a
                className="text-sm font-semibold text-soft py-2.5 border-b border-line last:border-0"
                href={l.h}
                key={l.l}
...
function HeroBackdrop() {
  return (
    <div className="absolute inset-0 -z-10 overflow-hidden pointer-events-none">
      <div
        className="absolute top-[-15%] right-[-10%] w-[680px] h-[680px] rounded-full"
        style={{
          background:
            "radial-gradient(circle, rgba(37,99,235,0.50), transparent 65%)",
          filter: "blur(80px)",
        }}
      />
      <div
        className="absolute top-[20%] left-[28%] w-[560px] h-[560px] rounded-full"
        style={{
          background:
      ...
      />
      <div
        className="absolute bottom-[-20%] left-[-10%] w-[520px] h-[520px] rounded-full"
        style={{
          background:
      ...
      />
      <div
        className="absolute inset-0 grid-bg grid-bg-mask"
        style={{ opacity: 0.5 }}
      />
    </div>
  )
    ...
    <div className="surface rounded-2xl p-4 w-[244px] shadow-[0_24px_60px_-18px_rgba(0,0,0,0.55)]">
      <div className="flex items-center justify-between">
        ...
        <svg
          ...
          width="22"
        >
          <path d="M7 9a3 3 0 100 6c1.4 0 2.3-1 3-2 .7 1 1.6 2 3 2a3 3 0 100-6c-1.4 0-2.3 1-3 2-.7-1-1.6-2-3-2z" />
        </svg>
      </div>
      ...
      <div className="flex gap-2 mt-3.5" dir="ltr">
        {icons.map((Icon, i) => (
          <div
            className="w-[42px] h-[42px] rounded-xl surface-soft border border-line grid place-items-center"
            key={i}
          >
            <Icon size={24} />
          </div>
  ...
  return (
    <div className="surface rounded-2xl p-4 w-[256px] shadow-[0_24px_60px_-18px_rgba(0,0,0,0.55)]">
      ...
      <div className="flex flex-col gap-0.5">
        {rows.map((r, i) => (
          <div
            className="flex items-center gap-2.5 px-1.5 py-2 rounded-xl hover:bg-[color:var(--bg-muted)] transition"
            key={i}
          >
            ...
            <div className="flex-1 min-w-0 text-start">
              ...
              <div className="text-[11.5px] text-mute truncate mt-0.5">
                {r.p}
              </div>
            </div>
            <span className="text-[11px] text-mute shrink-0" dir="ltr">
              {r.t}
            </span>
          </div>
        ))}
      ...
      <a
        className="flex items-center gap-1.5 mt-2 px-1.5 py-1.5 text-[13px] font-bold"
        href="#preview"
        style={{ color: "var(--secondary)" }}
      >
        عرض جميع المحادثات
    ...
    <div className="surface rounded-2xl p-4 w-[206px] shadow-[0_24px_60px_-18px_rgba(0,0,0,0.55)]">
      ...
      <div className="flex items-center gap-3">
        <div className="relative w-16 h-16 shrink-0">
          ...
          <div className="absolute inset-0 grid place-items-center font-extrabold text-[13.5px]">
            96.8%
          </div>
        </div>
      ...
      >
        <defs>
          <linearGradient id="spk" x1="0" x2="0" y1="0" y2="1">
            <stop offset="0" stopColor="#3B7BFF" stopOpacity=".35" />
            <stop offset="1" stopColor="#3B7BFF" stopOpacity="0" />
          </linearGradient>
        </defs>
        <path
          d="M2 44 L34 38 L64 41 L96 26 L128 29 L160 15 L188 7 L188 54 L2 54 Z"
          fill="url(#spk)"
        />
        <path
          d="M2 44 L34 38 L64 41 L96 26 L128 29 L160 15 L188 7"
          fill="none"
          stroke="#4D86FF"
          strokeLinecap="round"
          strokeLinejoin="round"
          strokeWidth="2.4"
        />
        <circle cx="188" cy="7" fill="#22D3EE" r="3.2" />
      </svg>
      <div
  ...
  return (
    <div className="surface rounded-2xl p-4 w-[200px] shadow-[0_24px_60px_-18px_rgba(0,0,0,0.55)]">
      ...
      <div className="flex flex-col gap-2.5">
        {tasks.map((t, i) => (
          <div
            className={`flex items-center gap-2.5 text-[13px] ${t.done ? "" : "text-mute"}`}
            key={i}
          >
            {t.done ? (
              <span
                ...
                style={{
                  background: "linear-gradient(135deg,#1E9E8F,#22D3EE)",
                }}
              >
                <svg
                  fill="none"
  ...
  return (
    <div className="relative mx-auto w-[280px]">
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(50% 50% at 50% 42%, rgba(45,130,255,0.42), rgba(34,211,238,0.16) 55%, transparent 76%)",
          filter: "blur(10px)",
        }}
      />
      {/* rings */}
      <div className="absolute inset-0 -z-10 grid place-items-center pointer-events-none">
        <div className="relative" style={{ width: "150%", aspectRatio: "1/1" }}>
          <div
            className="absolute inset-0 rounded-full orbit-ring--slow"
            style={{ border: "1px solid var(--line-strong)" }}
          />
          <div
            className="absolute inset-[12%] rounded-full orbit-ring--rev"
...
const PILLS = [
  ...
  { l: "ردود ذكية", icon: <Spark color="var(--secondary)" size={15} /> },
  {
    l: "أتمتة متقدمة",
    icon: (
      <svg
  ...
  return (
    <div style={{ textAlign: align }}>
      ...
      >
        ...
        <a
          className="btn-ghost"
          href="mailto:support@wesal.one?subject=%D8%B7%D9%84%D8%A8%20%D8%B9%D8%B1%D8%B6%20%D8%AA%D8%AC%D8%B1%D9%8A%D8%A8%D9%8A"
          style={{
            display: "inline-flex",
            alignItems: "center",
            gap: 8,
    ...
    <div style={{ position: "relative", ...style }}>
      <div
        style={{
          ...
          inset: "-20% -10%",
          background:
            "radial-gradient(50% 50% at 50% 44%, rgba(45,130,255,0.42), rgba(34,211,238,0.16) 55%, transparent 76%)",
          filter: "blur(10px)",
          pointerEvents: "none",
          zIndex: 0,
        }}
      ...
      <img
        alt=""
        src="/assets/wesal/hero-hologram.png"
        style={{
          width: "100%",
          height: "100%",
          objectFit: "contain",
      ...
      >
        ...
        <div
          style={{
            ...
            height: 630,
            background:
              "radial-gradient(50% 50% at 50% 44%, rgba(37,99,235,0.38), rgba(34,211,238,0.18) 55%, transparent 76%)",
            filter: "blur(12px)",
            pointerEvents: "none",
          }}
        />
        ...
        >
          <div
            style={{ position: "relative", width: "130%", aspectRatio: "1/1" }}
          >
            <div
              className="orbit-ring--slow"
              style={{
                position: "absolute",
                inset: 0,
                borderRadius: "50%",
        ...
        <img
          ...
          style={{
            ...
            zIndex: 2,
            pointerEvents: "none",
            filter: "brightness(1.28) contrast(1.1) saturate(1.15)",
          }}
        />
        ...
        <div
          className="float-y"
          style={{ position: "absolute", left: 40, top: 38, zIndex: 5 }}
        >
          <HeroConnectCard />
        </div>
        ...
        <div
          className="float-y"
          style={{ position: "absolute", left: 40, top: 280, zIndex: 5 }}
        >
          <HeroInboxCard />
        </div>
        ...
        <div
          className="float-y"
          style={{ position: "absolute", left: 786, top: 66, zIndex: 5 }}
        >
          <HeroPerfCard />
        </div>
        ...
        <div
          className="float-y"
          style={{ position: "absolute", left: 826, top: 342, zIndex: 5 }}
        >
          <HeroTasksCard />
        </div>
  ...
  return (
    ...
    >
      <div className="text-center">
        <HeroText centered fs="clamp(32px,7vw,46px)" />
      </div>
      ...
      <div className="container-page">
        <div className="platform-preview-header">
          ...
          <div className="reveal platform-preview-tabs flex justify-center">
            <div
              className="inline-flex p-1 rounded-xl surface gap-1"
              role="tablist"
            >
              {tabs.map((t) => {
                const active = tab === t.id
        ...
        <div
          className="reveal relative mx-auto platform-dashboard-frame"
          style={{ maxWidth: 1180 }}
        >
          {/* glow خفيف خلف الإطار */}
          <div
            className="absolute -inset-10 rounded-[40px] pointer-events-none -z-10"
            style={{
              background:
                "radial-gradient(80% 60% at 50% 0%, color-mix(in srgb, var(--primary) 22%, transparent), transparent 70%)",
              filter: "blur(50px)",
            }}
          ></div>
  ...
  return (
    <aside className="flex flex-col gap-4">
      ...
      <div>
        <div className="flex items-center gap-3">
          <div
            className="w-12 h-12 rounded-full grid place-items-center text-white text-base font-bold"
            style={{ background: "var(--primary)" }}
          >
            W
          </div>
  ...
  return (
    <div className="container-page py-14 sm:py-20">
      <div className="grid lg:grid-cols-12 gap-10 lg:gap-14 items-center">
        <div
          className={`lg:col-span-5 reveal ${side === "right" ? "lg:order-1" : "lg:order-2"}`}
        >
          <div
            className="inline-flex items-center gap-2 text-[11px] font-bold tracking-wider uppercase"
            style={{ color }}
          >
            <span className="w-6 h-px" style={{ background: color }} />
            {kicker}
          </div>
          <h3 className="mt-3 text-3xl sm:text-4xl font-extrabold leading-[1.2]">
            {title}
          </h3>
          <p className="mt-4 text-[15px] sm:text-[16px] leading-[1.95] text-soft max-w-xl">
            {desc}
          </p>
          <ul className="mt-6 space-y-2.5">
            {bullets.map((b) => (
              <li
                className="flex items-center gap-2.5 text-[14px] text-soft"
                key={b}
              >
                <span
        ...
        <div
          className={`lg:col-span-7 reveal ${side === "right" ? "lg:order-2" : "lg:order-1"}`}
        >
          {/* halo خلف الـ visual */}
          <div className="relative">
            <div
              className="absolute -inset-6 rounded-[28px] pointer-events-none -z-10"
              style={{
  ...
  const smile = (
    ...
    >
      ...
      <path
        ...
        strokeLinecap="round"
      />
      <circle cx="9" cy="10" fill="currentColor" r=".5" />
      <circle cx="15" cy="10" fill="currentColor" r=".5" />
    </svg>
  )
  const bld = (
    <svg
  ...
  return (
    <section className="relative" style={{ zIndex: 6 }}>
      <div className="stats-strip">
        <div
          className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-x-4 gap-y-6"
          dir="ltr"
        >
          {stats.map((s, i) => (
            <div
            ...
            >
              <span
                ...
                style={{
                  background: "rgba(96,142,255,0.10)",
                  border: "1px solid var(--line)",
                  color: "var(--secondary)",
                }}
              >
              ...
              <div className={s.lead ? "text-start" : "text-end"}>
                <div
                  className={`font-extrabold ${s.lead ? "text-[19px] sm:text-[21px]" : "text-[24px] sm:text-[26px]"}`}
                  style={{ color: "var(--fg)" }}
                >
                  {s.v}
                </div>
                <div className="mt-1 text-[12.5px] text-mute font-semibold">
                  {s.l}
                </div>
              </div>
              {i < stats.length - 1 && (
                <div
                  className="hidden lg:block absolute top-1/2 -translate-y-1/2 -start-2 h-9 w-px"
                  style={{ background: "var(--line)" }}
                ></div>
              )}
            </div>
    ...
    <section className="testimonials-section" id="stories">
      <div className="container-page">
        ...
        <div className="testimonials-grid">
          {items.map((it, i) => (
            <div
              className="testimonial-card p-6 reveal flex flex-col"
              key={it.name}
              style={{
                animation: `fade-up .55s cubic-bezier(.22,1,.36,1) ${0.08 * i}s both`,
              }}
            >
                ...
                <div className="flex items-center gap-0.5">
                  {[0, 1, 2, 3, 4].map((s) => (
                    <span
                      className="w-1.5 h-1.5 rounded-full"
                      key={s}
                      style={{ background: it.c, boxShadow: `0 0 6px ${it.c}` }}
                    ></span>
                  ))}
                </div>
              </div>
              ...
              {/* title + text */}
              <div className="text-[15px] font-extrabold leading-tight mb-2">
                {it.title}
              </div>
              <p className="text-[13px] text-soft leading-[1.85] flex-1">
                {it.text}
              </p>
              ...
              >
                <div
                  className="w-9 h-9 rounded-lg grid place-items-center text-white text-[12px] font-extrabold shrink-0"
                  style={{
                    background: `linear-gradient(135deg, ${it.c}, var(--primary))`,
                  }}
                >
                  {it.name.charAt(0)}
                </div>
                <div className="leading-tight min-w-0">
                  ...
                  <div className="text-[10.5px] text-mute truncate">
                    {it.role}
                  </div>
                </div>
              </div>
      ...
      {[
        ...
        return (
          ...
          >
            ...
            {opt.id && (
              <span
                className="absolute -top-2 -end-2 text-[9.5px] font-extrabold px-1.5 py-0.5 rounded-full text-white"
                style={{
                  background: "var(--secondary)",
                  boxShadow:
...
function PriceCard({
  ...
  return (
    ...
    >
      {featured && (
        <div
          className="absolute -top-3 right-1/2 translate-x-1/2 text-[10px] font-extrabold tracking-wider px-3 py-1 rounded-full text-white whitespace-nowrap"
          style={{
            background:
              "linear-gradient(135deg, var(--primary), var(--secondary))",
            boxShadow:
      ...
      <p className="mt-1.5 text-[12.5px] text-soft leading-relaxed min-h-[44px]">
        {desc}
      </p>
      ...
      <ul className="space-y-2.5 flex-1">
        {features.map((f) => (
          <li
            className="flex items-start gap-2.5 text-[12.5px] text-soft leading-relaxed"
            key={f}
          >
            <span
      ...
      {/* CTA — أسفل البطاقة */}
      <a
        className={`mt-6 inline-flex w-full items-center justify-center px-5 py-3 rounded-xl font-extrabold text-[13.5px] transition ${featured ? "btn-primary" : "btn-ghost"}`}
        href={href}
      >
        {cta}
        <svg
      ...
      <div className="container-page">
        ...
        <div className="text-center max-w-2xl mx-auto mb-8">
          ...
          <div className="reveal mt-6 flex justify-center">
            <PricingToggle setYearly={setYearly} yearly={yearly} />
          </div>
        </div>
            ...
            {items.map((it, i) => {
              ...
              return (
                <div
                  ...
                  key={i}
                  style={{
                    animation: `fade-up .55s cubic-bezier(.22,1,.36,1) ${i * 0.05}s both`,
                  }}
                >
                  <button
                  ...
                  >
                    <span className="text-[15px] sm:text-[16px] font-bold leading-[1.5] pe-2">
                      {it.q}
                    </span>
                    <span
...
function FinalCTABig() {
  ...
  return (
    <section className="final-cta-section" id="cta">
      <div className="container-page">
        <div
          className="final-cta-card reveal"
          style={{ animation: "fade-up .7s cubic-bezier(.22,1,.36,1) both" }}
        >
        ...
        <div className="footer-grid">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {product.map((l) => (
                <li key={l}>
                  <a className="footer-link" href="#preview">
                    {l}
                  </a>
                </li>
              ))}
