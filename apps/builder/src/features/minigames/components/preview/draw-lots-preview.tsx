...
import { DrawLotsArt, JackpotStartButton } from "@chatbotx.io/minigame-ui"
import { cn } from "@chatbotx.io/ui/lib/utils"
import { Share2Icon } from "lucide-react"
import { useTranslations } from "next-intl"
import { MinigamePreviewLayout } from "./minigame-preview-layout"

type DrawLotsPreviewProps = {
  name: string
  showName: boolean
...
export function DrawLotsPreview({
  name,
  showName,
  rulesDescription,
  appearance,
  shareEnabled,
}: DrawLotsPreviewProps) {
  ...
  return (
    <MinigamePreviewLayout
      ...
      name={name || t("minigames.preview.drawLotsHeader")}
