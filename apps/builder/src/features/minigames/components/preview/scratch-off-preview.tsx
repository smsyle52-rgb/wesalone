...
import { JackpotStartButton, ScratchOffArt } from "@chatbotx.io/minigame-ui"
import { cn } from "@chatbotx.io/ui/lib/utils"
import { Share2Icon } from "lucide-react"
import { useTranslations } from "next-intl"
import { MinigamePreviewLayout } from "./minigame-preview-layout"

type ScratchOffPreviewProps = {
  name: string
  showName: boolean
...
export function ScratchOffPreview({
  name,
  showName,
  rulesDescription,
  appearance,
  shareEnabled,
}: ScratchOffPreviewProps) {
  ...
  return (
    <MinigamePreviewLayout
      ...
      name={name || t("minigames.preview.scratchOffHeader")}
