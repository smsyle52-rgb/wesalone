 ...
 * optimization plus Automatic Events; the messaging-ads box moved to the
 * standalone Click to Message Ads tool. Kept as a redirect (not deleted) so
 * old bookmarks/links to `.../capi` keep working.
 */
