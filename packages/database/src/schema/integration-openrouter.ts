...
export const integrationOpenrouterModel = pgTable(
  "IntegrationOpenrouter",
  {
    ...sharedColumns,
    auth: jsonb().notNull(),
  ...
  (table) => [
    uniqueIndex("IntegrationOpenrouter_workspaceId_key").using(
      "btree",
      table.workspaceId.asc().nullsLast(),
    ),
    uniqueIndex("IntegrationOpenrouter_integrationId_key").using(
      "btree",
