...
export const integrationDeepseekModel = pgTable(
  "IntegrationDeepseek",
  {
    ...sharedColumns,
    auth: jsonb().notNull(),
  ...
  (table) => [
    uniqueIndex("IntegrationDeepseek_workspaceId_key").using(
      "btree",
      table.workspaceId.asc().nullsLast(),
    ),
    uniqueIndex("IntegrationDeepseek_integrationId_key").using(
      "btree",
