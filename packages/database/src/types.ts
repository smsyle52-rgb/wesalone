...
export type PlatformSubscriptionModel =
  typeof schema.platformSubscriptionModel.$inferSelect
export type BillableUsageEventModel =
  typeof schema.billableUsageEventModel.$inferSelect
