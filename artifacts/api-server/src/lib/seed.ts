...
const SYSTEM_PERMISSIONS = [
  ...
  { resource: "products", action: "read", slug: "products:read", description: "عرض المنتجات" },
  { resource: "products", action: "create", slug: "products:create", description: "إضافة منتجات" },
  { resource: "products", action: "update", slug: "products:update", description: "تعديل المنتجات" },
  { resource: "products", action: "delete", slug: "products:delete", description: "أرشفة المنتجات" },
...
const SYSTEM_PLANS = [
  ...
  },
  {
    ...
    limits: { channels: 1, agents: 1, team_members: 2, contacts: 1000, monthly_points: 10000, knowledge_documents: 1, products: 500, auto_reply: true },
    features: ["inbox", "ai_agent", "catalog", "basic_automation"],
  },
  {
    name: "Growth", slug: "growth", key: "growth", nameAr: "النمو",
    priceUsd: "49", priceUsdAnnual: "470", priceSar: "183.75", priceYer: null,
    billingCycle: "monthly", sortOrder: 30,
    limits: { channels: 3, agents: 3, team_members: 5, contacts: 10000, monthly_points: 40000, knowledge_documents: 5, products: 5000, auto_reply: true },
  ...
  },
  {
    ...
    priceUsd: "140", priceUsdAnnual: "1344", priceSar: "525", priceYer: null,
    billingCycle: "monthly", sortOrder: 40,
    limits: { channels: 10, agents: 10, team_members: 15, contacts: 50000, monthly_points: 100000, knowledge_documents: 20, products: 25000, auto_reply: true },
  ...
  },
  {
    ...
    limits: { channels: "custom", agents: "custom", team_members: "custom", contacts: "custom", monthly_points: "custom", knowledge_documents: "custom", products: "custom", auto_reply: true },
