...
export default function LoginPage() {
  ...
  return <AuthLayout visualTitle="منصة موحّدة لمحادثات عملائك." visualSubtitle="أدر واتساب، إنستغرام، ماسنجر، وتيليجرام من لوحة تحكم واحدة." visualBullets={["صندوق وارد موحّد", "تقارير حيّة وقابلة للتصدير", "أمان وخصوصية على أعلى مستوى"]}>
