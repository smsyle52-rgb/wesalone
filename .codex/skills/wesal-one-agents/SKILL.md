...
1. اقرأ `references/launch-readiness-plan.md` + `WESAL_ONE_CHAT_HANDOFF.md` (الحالة الحيّة).
2. طبّق **الحلقة التشغيلية** (القسم 0 من الخطة): جِد أول نطاق ليس ✅ → افحص (read-only) أو أصلح حسب حالته → توقّف وانتظر القرار.
3. التزم **المحميات** ومعايير الهندسة (القسم 2 من الخطة) في كل خطوة.

## الملفات المرجعية
| الملف | المحتوى |
|---|---|
| `references/launch-readiness-plan.md` | **الدستور التشغيلي** — الحلقة، الصورة الكاملة، معايير الكود، تسلسل النطاقات وجدول الجاهزية. اقرأه أولاً. |
...
- **النشط الآن:** خطة جاهزية الإطلاق — نبدأ بالنطاق 1 (المصادقة والجلسات) ثم النطاق 2 (عزل العملاء، الأخطر).
